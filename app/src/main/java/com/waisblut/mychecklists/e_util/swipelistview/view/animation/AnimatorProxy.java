package com.waisblut.mychecklists.e_util.swipelistview.view.animation;
        ...
        extends Animation
{
     ...
     */
    public static final boolean NEEDS_PROXY = Integer.valueOf(Build.VERSION.SDK)
                                                     .intValue() < Build.VERSION_CODES.HONEYCOMB;
